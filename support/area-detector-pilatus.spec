...
%global epics_prefix /opt/epics/support/areaDetector/pilatus

Name:			area-detector-pilatus
Version:		%{_version}
...
BuildRequires:	epics-base area-detector-core area-detector-support
Requires:		epics-base area-detector-core area-detector-support

%description
EPICS Drivers for Pilatus Detectors
...
cp -a  %{_builddir}/%{?buildsubdir}/pilatusApp/op/!(Makefile) %{buildroot}%{epics_prefix}/op
cp -a  %{_builddir}/%{?buildsubdir}/pilatusApp/Db/*.req %{buildroot}%{epics_prefix}/db
...
%changelog
* Sun Oct 29 2023 Abdalla Al-Dalleh 2.9-0
  - Initial Release
