# 
# Busy record support for EPICS
#
# Author: Abdalla Al-Dalleh <abdalla.ahmad@sesame.org.jo>
#

%global epics_prefix /opt/epics/support/busy

Name:			busy
Version:		%{_version}
Release:		%{build_number}%{?dist}
Summary:		Busy record support for EPICS
Group:			Applications/Engineering
License:		GPL+
URL:			https://epics.anl.gov
Source0:		%{name}-%{_version}.%{build_number}.tar.gz
BuildRequires:	epics-base asyn autosave
Requires:		epics-base asyn autosave
...
cp -a %{_builddir}/%{?buildsubdir}/busyApp/op/!(Makefile) %{buildroot}%{epics_prefix}/op
...
%changelog
* Tue May 18 2021 Abdalla Al-Dalleh 1.7.3
  - New build sequence.
