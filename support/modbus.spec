...
%global epics_prefix /opt/epics/support/modbus

Name:			modbus
Version:		%{_version}
Release:		%{build_number}%{?dist}
Summary:		Modbus driver support for EPICS
...
cp -a %{_builddir}/%{?buildsubdir}/modbusApp/op/!(Makefile) %{buildroot}%{epics_prefix}/op
...
%changelog
* Sun May 16 2021 Abdalla Al-Dalleh 3.2
  - New build sequence.
